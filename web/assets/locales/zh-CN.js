...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'channels.importUrlsTitle': '批量导入 URL',
  'channels.importUrls': '导入URL',
  ...
  'channels.pasteApiUrls': '粘贴 API URLs',
  'channels.pasteApiKeys': '粘贴API Keys',
  'channels.urlsSeparatorHint': '(支持逗号或换行分隔)',
  'channels.keysSeparatorHint': '(支持逗号或换行分隔)',
  'channels.usageInstructions': '使用说明：',
  'channels.commaSeparatedUrl': '支持逗号分隔：',
  'channels.newlineSeparatedUrl': '支持换行分隔：每行一个URL',
  'channels.httpHttpsOnly': '仅允许 http/https，自动忽略重复URL',
  'channels.blockPrivateUrls': '禁止 localhost、内网和回环地址',
  'channels.urlLengthLimitHint': '单个URL最长 2048 字符，整段输入最长 50000 字符',
  'channels.commaSeparated': '支持逗号分隔：',
  'channels.newlineSeparated': '支持换行分隔：每行一个Key',
  'channels.autoDedup': '自动去除空格、空行和重复Key',
  'channels.parseSuccessUrls': '解析成功：将导入',
  ...
  'channels.clearCooldown': '清冷却',
  'channels.exportUrls': '导出URL',
  'channels.exportUrlsTitle': '导出URL',
  'channels.exportPlainUrl': '纯URL',
  'channels.exportUrlWithKey': 'URL带Key',
  'channels.noUrlsToExport': '没有URL可导出',
  'channels.noThinkingModels': '不思考的模型',
  'channels.clearNoThinking': '清除黑名单',
  'channels.noThinkingCleared': '已清除thinking黑名单',
  'channels.clearCooldownTitle': '清除该渠道所有冷却（渠道+Key+URL）',
  'channels.cooldownCleared': '冷却已清除',
  ...
  'channels.urlImportSuccess': '成功导入 {added} 个URL',
  'channels.urlImportPartialSuccess': '成功导入 {added} 个URL，已跳过 {skipped} 项',
  'channels.urlImportDuplicatesIgnored': '已忽略 {count} 个重复URL',
  'channels.urlImportInvalidEntries': '{count} 项无效输入',
  'channels.urlImportInvalidSummary': '{count} 个无效URL无法导入',
  'channels.urlImportInvalidMore': '... 以及另外 {count} 个无效项',
  'channels.enterAtLeastOneUrl': '请至少输入一个URL',
  'channels.noValidUrlParsed': '未解析到有效URL，请检查格式和地址',
  'channels.allUrlsExist': '导入的URL已全部存在',
  'channels.urlImportInputTooLong': '输入内容过长（最多 {max} 个字符）',
  'channels.invalidUrlEntry': '无效 URL "{value}"：{reason}',
  'channels.urlValidationProtocol': '仅允许 http:// 或 https:// URL',
  'channels.urlValidationPrivate': '禁止使用内网、localhost 或回环地址',
  'channels.urlValidationMalformed': 'URL 格式不正确',
  'channels.urlValidationTooLong': 'URL 超过 2048 字符长度限制',
