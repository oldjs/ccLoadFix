...
window.I18N_LOCALES['en'] = {
  ...
  'channels.importUrlsTitle': 'Bulk Import URLs',
  'channels.importUrls': 'Import URLs',
  ...
  'channels.pasteApiUrls': 'Paste API URLs',
  'channels.pasteApiKeys': 'Paste API Keys',
  'channels.urlsSeparatorHint': '(Comma or newline separated)',
  'channels.keysSeparatorHint': '(Comma or newline separated)',
  'channels.usageInstructions': 'Usage:',
  'channels.commaSeparatedUrl': 'Comma separated:',
  'channels.newlineSeparatedUrl': 'Newline separated: one URL per line',
  'channels.httpHttpsOnly': 'Only http/https allowed, duplicate URLs are skipped automatically',
  'channels.blockPrivateUrls': 'Localhost, private and loopback addresses are blocked',
  'channels.urlLengthLimitHint': 'Each URL up to 2048 chars, total input up to 50000 chars',
  ...
  'channels.parseSuccessUrls': 'Parsed: will import',
  ...
  'channels.clearCooldown': 'Clear CD',
  'channels.exportUrls': 'Export',
  'channels.exportUrlsTitle': 'Export URLs',
  'channels.exportPlainUrl': 'Plain URLs',
  'channels.exportUrlWithKey': 'URLs with Key',
  'channels.noUrlsToExport': 'No URLs to export',
  'channels.noThinkingModels': 'No thinking models',
  'channels.clearNoThinking': 'Clear blacklist',
  'channels.noThinkingCleared': 'Thinking blacklist cleared',
  'channels.clearCooldownTitle': 'Clear all cooldowns (channel + key + URL)',
  'channels.cooldownCleared': 'Cooldowns cleared',
  ...
  'channels.urlImportSuccess': 'Successfully imported {added} URLs',
  'channels.urlImportPartialSuccess': 'Successfully imported {added} URLs, skipped {skipped} entries',
  'channels.urlImportDuplicatesIgnored': '{count} duplicate URLs ignored',
  'channels.urlImportInvalidEntries': '{count} invalid entries',
  'channels.urlImportInvalidSummary': '{count} invalid URLs could not be imported',
  'channels.urlImportInvalidMore': '... and {count} more invalid entries',
  'channels.enterAtLeastOneUrl': 'Please enter at least one URL',
  'channels.noValidUrlParsed': 'No valid URL parsed, please check the format and address',
  'channels.allUrlsExist': 'All imported URLs already exist',
  'channels.urlImportInputTooLong': 'Input is too long (max {max} characters)',
  'channels.invalidUrlEntry': 'Invalid URL "{value}": {reason}',
  'channels.urlValidationProtocol': 'Only http:// or https:// URLs are allowed',
  'channels.urlValidationPrivate': 'Private, localhost and loopback addresses are not allowed',
  'channels.urlValidationMalformed': 'Malformed URL',
  'channels.urlValidationTooLong': 'URL exceeds the 2048 character limit',
